...
import { getTermsAndConditions, updateTermsAndConditions } from '@services/api';
...
export default function TermsConditionsAdminPage() {
  ...
  const { isLoading } = useQuery('termsConditions', getTermsAndConditions, {
    onSuccess: (data) => {
      if (data) {
        reset(data);
  ...
  const updateMutation = useMutation(updateTermsAndConditions, {
    onSuccess: () => {
  ...
  return (
    <Card title="Manage Terms & Conditions" className="max-w-4xl mx-auto mt-6 mb-12">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-4 md:p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Textinput
              label="SEO Title"
              name="seoTitle"
              placeholder="Enter SEO title for Terms & Conditions"
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              This will appear as a subtitle in the header of the terms & conditions page.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <MediaUpload 
            ...
            helperText="Recommended size: 1200x400px. This image will be displayed at the top of the terms & conditions page."
          />
        </div>
        ...
        <div>
          ...
          <TipTapEditor
            ...
            placeholder="Enter the terms and conditions details here..."
          />
        </div>
        ...
        <div className="flex justify-end pt-4 border-t">
          <Button
            type="submit"
            text={updateMutation.isLoading ? 'Saving...' : 'Save Terms & Conditions'}
