...
import { getCookiePolicy, updateCookiePolicy } from '@services/api';
...
export default function CookiePolicyAdminPage() {
  ...
  const { isLoading, error } = useQuery('cookiePolicy', getCookiePolicy, {
    onSuccess: (data) => {
      if (data) {
        reset(data);
  ...
  const updateMutation = useMutation(updateCookiePolicy, {
    onSuccess: () => {
  ...
  return (
    <Card title="Manage Cookie Policy" className="max-w-4xl mx-auto mt-6 mb-12">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-4 md:p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Textinput
              label="SEO Title"
              name="seoTitle"
              placeholder="Enter SEO title for Cookie Policy"
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              This will appear as a subtitle in the header of the cookie policy page.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <MediaUpload 
            ...
            helperText="Recommended size: 1200x400px. This image will be displayed at the top of the cookie policy page."
          />
        </div>
        ...
        <div>
          ...
          <TipTapEditor
            ...
            placeholder="Enter the cookie policy details here..."
          />
        </div>
...
//       const payload = {
//         ...formData,
//         description: editorContent, // Get content from TipTap state
//       };
...
//           <Button
//             type="submit"
//             text={saving ? 'Saving...' : 'Save Privacy Policy'}
//             className="btn-primary"
//             disabled={saving}
//             isLoading={saving}
//           />
