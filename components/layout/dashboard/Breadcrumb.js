...
const Breadcrumb = ({ breadcrumbTitle }) => {
    return (
        <>
            <div className="flex flex-col items-center justify-between lg:items-center lg:space-y-0 lg:flex-row pb-3">
                <h4 className="text-2xl font-semibold whitespace-nowrap">{breadcrumbTitle}</h4>
